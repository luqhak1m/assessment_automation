...
export default class LeavePage {
    ...
    constructor(page: Page){
        ...
        this.status_filter_dropdown=page.locator(LeaveSelector.status_filter_dropdown);
    }
    ...
    async checkPendingApproval(){
        await this.page.locator(LeaveSelector.pending_approval_text('Pending Approval (5.00)')).click();
    }
    ...
    async searchEmployee(full_name: string){
        ...
        await this.page.locator(LeaveSelector.employee_search_option(full_name)).click();
    ...
    async selectEmployee(full_name: string){
        await this.page.locator(LeaveSelector.employee_cell(full_name)).first().click();
    }
    ...
    async searchEmployeeAndSelectLeave(full_name: string, status: string, leaveText: string){
        await this.navigateToLeaveList();
        await this.searchEmployee(full_name);
