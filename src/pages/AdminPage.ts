...
export default class AdminPage {
    ...
    constructor(page: Page){
        ...
        this.confirm_password_input=page.locator(AdminSelector.confirm_password_input);
    ...
    async clickUserManagementTab(){ 
        const tab=this.page.locator('role=listitem').filter({ hasText: 'User Management' });
        await tab.click();    }
    ...
    async clickSaveButton(){ await this.save_button.click(); }

    async createSystemUser(name: string, role: string, status: string, username: string, password: string){
