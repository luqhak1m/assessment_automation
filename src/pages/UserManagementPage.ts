...
export default class UserManagementPage{
    ...
    constructor(page: Page){
        ...
        this.add_supervisor_button=page.locator(UserManagementSelector.add_supervisor_button);
        this.supervisor_input=page.locator(UserManagementSelector.supervisor_input);
    ...
    async clickSupervisorOption(name: string){
        const option=this.page.locator(UserManagementSelector.supervisor_option(name));
        await option.click()
    }
